...
void readParameters(const string & config_file)
{
    //string config_file1 = "/data/local/tmp/com.hezhaoxin.solomon.vins_android/app/src/main/cpp/src/config/euroc/euroc_config.yaml";
 ...
 //   fsSettings["output_path"] >> VINS_RESULT_PATH;
  // VINS_FOLDER_PATH = "/storage/emulated/0/storage/emulated/0/vins/";
 VINS_FOLDER_PATH = "/data/vins/";
    ...
    LOGD("ACC_N:%f , ACC_W:%f ,GYR_N:%f , GYR_W:%f , G.z():%f",ACC_N, ACC_W, GYR_N, GYR_W,  G.z() );
	...
	LOGD("Extrinsic_R : ");
	LOGD("Extrinsic_R : %f            %f               %f",  RIC[0](0,0), RIC[0](0,1), RIC[0](0,2));
	LOGD("Extrinsic_R : %f            %f               %f",  RIC[0](1,0), RIC[0](1,1), RIC[0](1,2));
	LOGD("Extrinsic_R : %f            %f               %f",  RIC[0](2,0), RIC[0](2,1), RIC[0](2,2));
	LOGD("Extrinsic_T : %f   %f   %f", TIC[0].transpose()(0), TIC[0].transpose()(1), TIC[0].transpose()(2) );
   ...
   LOGD("VOC_FILE: %s", VOC_FILE.c_str());
   LOGD("PATTERN_FILE: %s", PATTERN_FILE.c_str());
    fsSettings.release();
}
